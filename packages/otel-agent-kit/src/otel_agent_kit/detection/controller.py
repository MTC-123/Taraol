"""Webhook controller that turns SigNoz alerts into scoped pause / edge-break actions."""
    ...
    def __init__(
        ...
        *,
        ...
        if enforce not in {"auto", "approve"}:
            raise ValueError("OAK_ENFORCE must be auto or approve")
...
def main() -> None:
    ...
    controller = Controller(
        ...
        enforce=os.environ.get("OAK_ENFORCE", "auto").lower(),
        cooldown_sec=int(os.environ.get("OAK_ALERT_COOLDOWN_SEC", "60")),
    )
