...
class A2AClient:
    ...
    def call(self, method: str, params: Mapping[str, Any], target_url: str) -> dict[str, Any]:
        ...
        with self.tracer.start_as_current_span(
            ...
            carried = taint_from_baggage(_NAMES)
            if carried is not None:
                mark_taint(span, carried, _NAMES)
            ...
            if not registry.allow(edge):
                span.set_attribute(_NAMES.breaker_state, registry.state_of(edge))
                span.set_attribute(_NAMES.breaker_edge, edge)
            ...
            if isinstance(meta, dict):
                ...
                if isinstance(cost_usd, (int, float)) and not isinstance(cost_usd, bool):
                    ...
                    span.set_attribute(_NAMES.cost_downstream_usd, normalized_cost)
